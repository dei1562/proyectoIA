...
var graph_image_old = null;

function reset_graph_zoom() {
  graph_image.panzoom('reset');
  // graph_image_old.panzoom('reset');  
}
...
function AlgorithmInfoCtrl($scope) {
  ...
  source.onmessage = function(event) {
    ...
    graph_image_old.attr('src', '/graphOld?unique=' + new Date().valueOf());
  };
}
...
$(document).ready(function() {
  ...
  graph_image.panzoom();
  graph_image.bind('mousewheel DOMMouseScroll', function(e) {
  ...
  graph_image_old = $('#graph_image_old').panzoom();
  // graph_image_old.panzoom();
  // graph_image_old.bind('mousewheel DOMMouseScroll', function(e) {
  //   if (e.originalEvent.wheelDelta / 120 > 0) {
  //     graph_image_old.panzoom('zoom');
  //   }
  //   else {
  //     graph_image_old.panzoom('zoom', true);
  //   }
  // });
